...
BLOG_TITLE = "Jez Cope"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://jcope.shef.ac.uk/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://jcope.staff.shef.ac.uk/"
BLOG_EMAIL = "j.s.cope@sheffield.ac.uk"
BLOG_DESCRIPTION = "My work homepage"  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        (
            (
                ("/talks/intro-to-rdm.html", "Introduction to RDM"),
                ("/talks/", "All"),
            ),
            "Talks"
        ),
...
POSTS_SECTION_DESCRIPTIONS = {
    DEFAULT_LANG: {
        'notes': 'A selection of my notes, mostly from meetings and conferences.',
    },
}
